...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('connection_id', 'external_account_id', name='bank_accounts_unique')
    )
    ...
    sa.ForeignKeyConstraint(['mapped_transaction_id'], ['transactions.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('bank_account_id', 'external_txn_id', name='imported_transactions_unique')
    )
    op.create_index(op.f('ix_imported_transactions_bank_account_id'), 'imported_transactions', ['bank_account_id'], unique=False)
    op.create_index(op.f('ix_imported_transactions_occurred_at'), 'imported_transactions', ['occurred_at'], unique=False)
    op.create_index(op.f('ix_imported_transactions_user_id'), 'imported_transactions', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_imported_transactions_occurred_at'), table_name='imported_transactions')
